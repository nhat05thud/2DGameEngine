			...
			if (event.symbol == SDLK_SPACE) {
				...
				for (auto entity: GetSystemEntities()) {
					if (entity.HasComponent<CameraFollowComponent>()) {
						...
						// if parent entity has sprite, start the projectile position in the middle of the sprite
						...
						// If parent entity direction is controlled by the keyboard keys, modify the projectile velocity
